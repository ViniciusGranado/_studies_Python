...
print(f'Acrescentando 10%, temos {currency.format_currency(currency.increase10percent(user_number, 10),)}.')
print(f'Subtraindo 15%, temos {currency.format_currency(currency.decrease10percent(user_number, 15))}.')
